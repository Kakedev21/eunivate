...
import TaskG from "../Guest/My_Task/TaskG";
                ...
                {tasks.map((task) => (
                  ...
                  >
                    ...
                    <div className="flex items-center relative z-10">
                      ...
                      <p className="ml-2 font-bold text-sm md:text-base">
                        {task.taskName}
                      </p>
                    </div>
                    <p className="hidden md:block text-center relative z-10">
                      {formatDate(task.dueDate)}
                    </p>
                    <div className="hidden md:flex items-center justify-center relative z-10">
                      <FaFlag
                        className={`mr-1 text-xs md:text-sm ${getPriorityColor(
                          task.priority
                        )}`}
                      />
                    ...
                    <p className="hidden md:block text-center relative z-10">
                      {task.objectiveCount} Objectives
                    </p>
                    <p className="text-center relative z-10 text-sm md:text-base">
                      {task.status}
                    </p>
                    <p className="text-right relative z-10 text-sm md:text-base">
                      {task.projectName}
                    </p>
                  </li>
                ))}
