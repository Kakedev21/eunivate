...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://eunivate-jys4.onrender.com/api/users/signup",
        {
          firstName,
          lastName,
          username,
          ...
          <div className="relative mt-4 flex items-center justify-between">
            <div className="flex-1">
              ...
              <label
                ...
                className="cursor-pointer w-52 flex items-center p-3 pl-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              >
