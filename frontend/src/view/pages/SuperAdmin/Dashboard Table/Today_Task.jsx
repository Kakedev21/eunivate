...
const Tooltip = ({ children, title }) => (
  <div className="relative group">
    {children}
    <div className="absolute hidden group-hover:flex bg-gray-700 text-white text-xs rounded-md p-2 whitespace-nowrap -top-10 left-1/2 transform -translate-x-1/2 z-50">
      {title}
    </div>
  </div>
);
