...
import { searchOptions } from './Search'; // Import the search options
import '../SuperAdmin/Css/Search.css'

const AdminNavbarG = ({ isAccountDropdownOpen, toggleAccountDropdown }) => {
